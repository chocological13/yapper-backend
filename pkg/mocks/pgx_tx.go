...
// Query provides a mock function with given fields: ctx, sql, arguments
func (_m *PgxTx) Query(ctx context.Context, sql string, arguments ...interface{}) (pgx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, arguments...)
	ret := _m.Called(_ca...)
...
// QueryRow provides a mock function with given fields: ctx, sql, arguments
func (_m *PgxTx) QueryRow(ctx context.Context, sql string, arguments ...interface{}) pgx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, arguments...)
	ret := _m.Called(_ca...)
